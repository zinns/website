...
The current implementation is a small bilingual landing site on `/` with anonymous in-progress
project summaries and visible placeholder content for reviews and people until real company
